<?php
    ...
    $holiday_query = "SELECT * FROM hoilday_master LIMIT $start, $limit ";
    $holiday_result = db_all($holiday_query);

    $holiday_query1 = "SELECT count(id) AS id FROM hoilday_master  ";
    $holiday_result1 = db_all($holiday_query1);
    $total = $holiday_result1[0]['id'];
