            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview">
                        <a href="DeanDashboard.php">
                            <i class="fa fa-dashboard"></i> <span>Dean Dashboard</span>
                        </a>
                    </li>
                    <li class="active treeview">
                        <a href="Deanentitle.php">
                            <i class="fa fa-cogs"></i> <span>Dean_Entitle</span>
                        </a>
                    </li>
                    <li class="active treeview">
                        <a href="Dean_my_leaves.php">
                            <i class="fa fa-folder-o"></i> <span>Dean_MyLeaves</span>
                        </a>
                    </li>

                    <li class="active treeview">
                        <a href="Deanholiday.php">
                            <i class="fa fa-calendar-check-o"></i> <span>Dean_Holiday & RH list</span>
                        </a>
                    </li>
