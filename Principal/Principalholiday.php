...
<head>
    ...
    <title>LTM || Principal_Holiday</title>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview">
                        <a href="PrincipalDashboard.php">
                            <i class="fa fa-dashboard"></i> <span>Principal Dashboard</span>
                        </a>
                    </li>
                    <li class="active treeview">
                        <a href="Principalentitle.php">
                            <i class="fa fa-cogs"></i> <span>Principal_Entitle</span>
                        </a>
                    </li>
                    <li class="active treeview">
                        <a href="Principal_my_leaves.php">
                            <i class="fa fa-folder-o"></i> <span>Principal_MyLeaves</span>
                        </a>
                    </li>

                    <li class="active treeview">
                        <a href="Principalholiday.php">
                            <i class="fa fa-calendar-check-o"></i> <span>Principal_Holiday & RH list</span>
                        </a>
                    </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body table-responsive no-padding" id="employee_table">
                                    ...
                                    <!-- Page changer
                                        <div class="box-tools">
                                        <ul class="pagination pagination-sm no-margin pull-centre">
                                            <li> <a href="Empholiday.php?page=<?= $Previous; ?>" aria-label="Previous">
                                                    <span aria-hidden="true">&laquo; Previous</span>
                                                </a></li>

                                            <?php for($i = 1; $i<= $pages; $i++) : ?>
                                            <li><a href="Empholiday.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                                            <?php endfor; ?>

                                            <li><a href="Empholiday.php?page=<?= $Next; ?>" aria-label="Next">
                                    ...
                                    <div class="card mt-4">
                                        <div class="card-body">
                                            <table class="table table-borderd">
                                                <thead>
                                                    <tr>
                                                        <th style='text-align:center;font-family:times-new-roman;'>SL
                                                            NO.
                                                        </th>
                                                        ...
                                                        <th style='text-align:center;font-family:times-new-roman;'>Day
                                                        </th>


                                                        <th style='text-align:center;font-family:times-new-roman;'>Date
                                                        </th>
                                                ...
                                                <tbody>
                                                    <?php 
                                                            if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                                            {
                                                                ...
                                                                $query = "SELECT * FROM hoilday_master  WHERE date BETWEEN '$from_date' AND '$to_date'  LIMIT $start, $limit ";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="exampleModalLabel">RH & Holiday Upload </h1>
