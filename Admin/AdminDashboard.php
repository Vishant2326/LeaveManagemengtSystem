...
<head>
    ...
    <title> LTM || Admin_Dashboard</title>
                                                        ...
                                                        <?php 
                                                           if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                                            ...
                                                            $query = "SELECT *
                                                                    ...
                                                                    WHERE la.design_id >1  AND  from_date  BETWEEN '$from_date'AND '$to_date'";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-success" name="approved"
                                                                    data-toggle="modal"
                                                                    data-target="#Approve">Approved</button>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                                        }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h5>Total Employess Leaves Approved:- <bold><?php
                            ...
                            if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $query = "SELECT COUNT(emp_id) AS em_count 
                                              ...
                                              WHERE approval_status = 1 AND from_date BETWEEN '$current_date' AND '$current_date'";
                    ...
                    <h5>Total Employess Leaves Pending :- <bold><?php
                                    if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                    {
                    ...
                    <h5>Total Employess Leaves Rejected:- <bold><?php
                                    if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                    {
